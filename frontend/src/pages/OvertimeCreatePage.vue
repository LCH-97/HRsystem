      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="flex-container">
          ...
          <select id="startTime" name="startTime" required v-model="form.startTime">
            <option value="" disabled :selected="!form.startTime">Select Start Time</option>
          </select>
        </div>
        <div class="flex-container">
          <label for="endTime">End Time</label>
          <select id="endTime" name="endTime" required v-model="form.endTime">
            <option value="" disabled :selected="!form.endTime">Select End Time</option>
          </select>
        </div>
        <div class="section-divider">Reason</div>
        <textarea v-model="form.reason" rows="4" cols="50" required></textarea>
