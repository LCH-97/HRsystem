  ...
  export default {
    ...
    methods: {
      ...
      viewOvertimeDetail(id) {
        window.location.href = `http://www.hello-r-loha.kro.kr/api/employee/overtime/read/${id}`;
      },
      async approveOvertime(id) {
        try {
          await axios.patch(`http://www.hello-r-loha.kro.kr/api/employee/overtime/approve/${id}`);
