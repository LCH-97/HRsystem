      ...
      <div class="content">
        <div class="row">
          <div class="form-group">
            ...
            <textarea placeholder="제목을 입력하세요." id="title" class="form-control" rows="1" v-model="updateInfo.title" required></textarea>
            <br /><br />
            <label for="content">내용:</label>
            <textarea placeholder="내용을 입력하세요." id="content" class="form-control" rows="7" v-model="updateInfo.content" required></textarea>
          </div>
          <br /><br />
          <div class="row">
            <div class="col-md-6">
        ...
        new Blob(
          [
            JSON.stringify({
              ...
              content: this.updateInfo.content,
