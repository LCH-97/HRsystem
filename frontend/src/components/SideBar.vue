<template>
                        ...
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="/signUp" data-bs-toggle="collapse"
                                ...
                                <div class="sb-nav-link-icon"><svg class="svg-inline--fa fa-table-columns"
                                    ...
                                    </svg><!-- <i class="fas fa-columns"></i> Font Awesome fontawesome.com --></div>
                                회원가입
                            ...
                            <a class="nav-link collapsed" href="/login" data-bs-toggle="collapse"
                                data-bs-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
                                <div class="sb-nav-link-icon"><svg class="svg-inline--fa fa-book-open"
                                    ...
                                    </svg><!-- <i class="fas fa-book-open"></i> Font Awesome fontawesome.com --></div>
                                로그인
                                <div class="sb-sidenav-collapse-arrow"><svg class="svg-inline--fa fa-angle-down"
                                        aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-down"
                                        role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"
                            ...
                            <a class="nav-link collapsed" href="/approve/list" data-bs-toggle="collapse"
                                data-bs-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
                                <div class="sb-nav-link-icon"><svg class="svg-inline--fa fa-book-open"
                                        aria-hidden="true" focusable="false" data-prefix="fas" data-icon="book-open"
                                        role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"
                            ...
                            <a class="nav-link collapsed" href="/overtimelist" data-bs-toggle="collapse"
    data-bs-target="#collapseOvertime" aria-expanded="false" aria-controls="collapseOvertime">
    <div class="sb-nav-link-icon">
        <svg class="svg-inline--fa fa-book-open" aria-hidden="true" focusable="false" data-prefix="fas"
            data-icon="book-open" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"
            data-fa-i2svg="">
            <path fill="currentColor"
                d="M249.6 471.5c10.8 3.8 22.4-4.1 22.4-15.5V78.6c0-4.2-1.6-8.4-5-11C247.4 52 202.4 32 144 32C93.5 32 46.3 45.3 18.1 56.1C6.8 60.5 0 71.7 0 83.8V454.1c0 11.9 12.8 20.2 24.1 16.5C55.6 460.1 105.5 448 144 448c33.9 0 79 14 105.6 23.5zm76.8 0C353 462 398.1 448 432 448c38.5 0 88.4 12.1 119.9 22.6c11.3 3.8 24.1-4.6 24.1-16.5V83.8c0-12.1-6.8-23.3-18.1-27.6C529.7 45.3 482.5 32 432 32c-58.4 0-103.4 20-123 35.6c-3.3 2.6-5 6.8-5 11V456c0 11.4 11.7 19.3 22.4 15.5z">
            </path>
    ...
    <div class="sb-sidenav-collapse-arrow">
        <svg class="svg-inline--fa fa-angle-down" aria-hidden="true" focusable="false" data-prefix="fas"
            data-icon="angle-down" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"
            data-fa-i2svg="">
            <path fill="currentColor"
                d="M169.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 274.7 54.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z">
            </path>
...
<div class="collapse" id="collapseOvertime" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
    <nav class="sb-sidenav-menu-nested nav">
        <router-link to="/overtimecreate" class="nav-link">초과 근무 생성</router-link>
        <router-link to="/overtime/edit" class="nav-link">초과 근무 수정</router-link>
        <router-link to="/overtime/approval" class="nav-link">초과 근무 승인 목록</router-link>
    </nav>
</div>

<!-- 초과 근무 임시 -->

<a class="nav-link" href="/overtimelist" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="true" aria-controls="collapseLayouts">
    <div class="sb-nav-link-icon"><svg class="svg-inline--fa fa-table-columns" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="table-columns" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
    ...
    초과 근무
    <div class="sb-sidenav-collapse-arrow"><svg class="svg-inline--fa fa-angle-down" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-down" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
...
<div class="collapse show" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion" style="">
    <nav class="sb-sidenav-menu-nested nav">
        <a class="nav-link" href="/overtimecreate">생성</a>
        <a class="nav-link" href="/overtimemodify">수정</a>
        <a class="nav-link" href="/overtimeapprovea">승인</a>
    </nav>
</div>
