      ...
      <div id="layoutSidenav_nav">
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            ...
            <div class="nav">
              ...
              <a id="GooutMenu" class="nav-link collapsed" @click.prevent="toggleGooutMenu">
                ...
                <div class="sb-sidenav-collapse-arrow">
                  <svg class="svg-inline--fa fa-angle-down" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-down" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
              ...
              <a class="nav-link collapsed" @click.prevent="toggleApproveMenu">
                <div class="sb-nav-link-icon">
                  <svg class="svg-inline--fa fa-table-columns" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="table-columns" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path fill="currentColor" d="M0 96C0 60.7 28.7 32 64 32H448c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96zm64 64V416H224V160H64zm384 0H288V416H448V160z"></path>
                  </svg>
              ...
              <a class="nav-link collapsed" @click.prevent="toggleOvertimeMenu">
                <div class="sb-nav-link-icon">
                  <svg class="svg-inline--fa fa-table-columns" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="table-columns" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path fill="currentColor" d="M0 96C0 60.7 28.7 32 64 32H448c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96zm64 64V416H224V160H64zm384 0H288V416H448V160z"></path>
                  </svg>
          ...
          <div class="sb-sidenav-footer">
            <div class="small">Hello_R_loha</div>
...
export default {
  ...
  data() {
    return {
      isGooutMenuOpen: false,
      isApproveMenuOpen: false,
      isOvertimeMenuOpen: false,
    };
  },
  methods: {
    toggleGooutMenu() {
      this.isGooutMenuOpen = !this.isGooutMenuOpen;
    },
    toggleApproveMenu() {
      this.isApproveMenuOpen = !this.isApproveMenuOpen;
    },
    toggleOvertimeMenu() {
      this.isOvertimeMenuOpen = !this.isOvertimeMenuOpen;
    },
  },
  components: {
